...
public class ErrorMessage {
    ...
    public static final String INVALID_RATE_FORMAT = "The exchange rate must be a positive number with up to 6 decimal places. The exchange rate should be from 1 to 1000";
